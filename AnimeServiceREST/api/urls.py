...
urlpatterns = [
    ...
    path('animes/<int:pk>/posts/<str:user>/',
         PostDestroyUpdate.as_view(), name='alter posts'),
    ...
    path('animes/<int:pk>/posts/<str:user>/<int:post>/',
         CommentCreateGet.as_view(), name='alter posts'),
]
